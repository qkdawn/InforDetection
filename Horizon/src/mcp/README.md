...
The MCP layer does not reimplement Horizon business logic. It reuses the existing fetch, score, filter, research, enrich, and summarize modules from the main codebase.
