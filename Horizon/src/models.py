...
class RSSSourceConfig(BaseModel):
    ...
    deployment_pool: Literal["daily", "weekly", "reserve", "x_watch"] = "daily"
    category: Optional[str] = None
...
class CollectionConfig(BaseModel):
    ...
    default_source_pool: Literal["daily", "weekly", "reserve", "x_watch"] = "daily"
    cross_run_dedup_enabled: bool = True
